    ...
    return (
        ...
        >
            ...
            <p className="mb-3 text-lg">
                ...
                <span className="font-bold">Master 2 en Développement web et mobile ainsi qu&apos;un Titre RNCP de Niveau 7</span>. Passioné par
                ...
                <span className="font-bold">Ma motivation ?</span>{" "}
                <span className="italic">Transformer des idées innovantes</span> en solutions concrètes. 
                Je suis à la recherche active <span className="font-bold">d&apos;un poste en CDI</span> en tant que développeur web ou mobile 
            ...
            <p className='text-lg'>
                ...
                J&apos;aime aussi{" "} <span className="font-bold">apprendre de nouvelles choses</span>. 
