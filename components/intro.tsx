        ...
        >
            ...
            <div>
                ...
                >
                    <Link
                        href="#contact"
                        className="group bg-gray-900 text-white px-7 py-3 mx-5 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105 transition"
                        onClick={() => {
                    ...
                    <a
                        ...
                        href="https://github.com/FrekiManagarm"
                        target="_blank"
                    >
                        <FaGithubSquare />
                    </a>
